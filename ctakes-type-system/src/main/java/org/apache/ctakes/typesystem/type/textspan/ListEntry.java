 ...
 * @generated */
public class ListEntry extends Annotation {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(ListEntry.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected ListEntry() {/* intentionally empty block */}
   ...
   */
  public ListEntry(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public ListEntry(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
