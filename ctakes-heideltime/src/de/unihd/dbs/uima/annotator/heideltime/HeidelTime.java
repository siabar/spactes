...
import org.apache.ctakes.typesystem.type.heideltime.Dct;
...
public class HeidelTime extends JCasAnnotator_ImplBase {
	...
	public void addTimexAnnotation(String timexType, int begin, int end, Sentence sentence, String timexValue, String timexQuant,
		...
		annotation.setFilename(sentence.getSegmentId());
		annotation.setSentId(sentence.getSentenceNumber());
		
		annotation.setEmptyValue(emptyValue);

		FSIterator iterToken = jcas.getAnnotationIndex(BaseToken.type).subiterator(sentence);
		String allTokIds = "";
	...
	public String getPosFromMatchResult(int tokBegin, int tokEnd, Sentence s, JCas jcas) {
		...
		FSIterator iterTok = jcas.getAnnotationIndex(BaseToken.type).subiterator(s);
