...
/**
 * Container class that holds a text span, actual text, and possible variant
 * text for a lookup token. This class maintains (forces) lowercase text for
 * lookup Author: SPF Affiliation: CHIP-NLP Date: 11/29/13
 */
@Immutable
final public class FastLookupToken {
	 ...
	 *
	 * @param value -
	 * @return true if {@code value} is a {@code FastLookupToken} and has a span
	 *         equal to this token's span
	 */
